...
To add a new model, write a new module under `src/pt_converter/adapters/`
...
from pt_converter.slicer.base import LayerSpec
...
from pt_converter.adapters import qwen3_5 as _qwen3_5  # noqa: E402,F401
